...
var tester = my_student.student8;
// console.log(tester);
...
// console.log('type.nothing[0].constructor:', types.nothing[0].constructor); // null
// console.log('type.nothing[1].constructor:', types.nothing[1].constructor); // undefined
...
// 생성자(일급함수객체)
// 생성자.portotype ---------> 프로토타입 객체 {}
// 객체생성 = new 생성자()
// 생성자로부터 객체의 모든 능력은 어디서 올까? (힘의 근원)
// 생성된객체.constructor         
// 프로토타입 객체 ??

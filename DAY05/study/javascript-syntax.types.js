...
// 선언된 변수에 값을 할당
// 할당되는 역할을 수행하는 연산자 -> 할당(대입) 연산자
lunch = 김밥; // 값: 김밥 // 김밥이라는 이름의 변수를 찾아요 -> 참조 오류(Reference Error)
lunch = "김밥"; // 값: "김밥"" // 김밥이라는 문자열 데이터를 찾아요 
lunch = '김밥'; // 값: '김밥' // "
...
// var dinner = 'lunch; // 점심에 먹은 것을 저녁에도 먹자
...
// var 101Team = 'IoI'; [X]
// var 10px = 'Ten Picel'; [X]
// 3. 이름 지을때 사용할 수 있는 특수문자는 정해져 있다.
// _, $ 를 제외한 다른 특수문자는 사용할 수 없다.
// var Team-101 = 'IoI'; [X]
// var @design-people = '디자인 피플'; [X]
var $ = '$ sign'; // 변수로 사용 가능하지만 직관적이고 명시적이지 않은 변수명
...
console.log('전역변수:', type_of_my_phone); // 'iphone'
...
// - null
// - Number   (정수, 실수, 소수) 0
// - String   홑따옴표, 쌍따옴표로 묶인 텍스트 ''(false), ' '(true-공백으로)
...
// 문자로서의 따옴표의 경우는 이스케이프(Escape) 처리해야 한다.
...
// 미리 살펴보는 DOM Script!
// DOMScript에서 Single var pattern을 사용한 예시
